...
public class Commons {
    ...
    public static String site_url(String sub) {
        return site_option("sete_url") + sub;
    }
     ...
     * @return
     */
    public static String parsedate_zh_m(String date) {
    ...
    public static Map<String, String> social() {
        ...
        map.put("jiashu", WebConst.initConfig.get(prefix + "jiashu"));
     ...
     * @return
     */
    public static String permalink(ContentDAO contentDAO){
        return permalink(contentDAO.getCid(),contentDAO.getSlug());
    }
