...
import com.nga.controller.admin.AttAchController;
...
public class TaleUtils {
     ...
     * @return
     */
    private static Properties gerPropFromFile(String fileName) {
    ...
    public static DataSource getNewDataSource() {
        if (newDataSource == null) synchronized (TaleUtils.class) {
            if (newDataSource == null) {
                Properties properties = TaleUtils.gerPropFromFile("application-default.properties");
                if (properties.size() == 0) {
                    return newDataSource;
                }
                DriverManagerDataSource managerDataSource = new DriverManagerDataSource();
                managerDataSource.setDriverClassName("com.mysql.jdbc.Driver");
                managerDataSource.setPassword("spring.datasource.password");
                String str = "jdbc:mysql://" + properties.getProperty("spring.datasource.url") + "/" + properties.getProperty("spring.datasource.dbname") + "?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&serverTimezone=UTC&useSSL=false";
    ...
    public static UserModel getLoginUser(HttpServletRequest request) {
        ...
        return (UserModel) session.getAttribute(WebConst.LOGIN_SESSION_KEY);
    }
    ...
    public static String getFileKey(String name) {
        String prefix = "/upload" + DateKitUtil.dateFormat(new Date(), "yyyy/MM");
